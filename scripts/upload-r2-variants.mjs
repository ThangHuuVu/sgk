...
const variantRoot = join(root, "generated", "r2-variants");
...
async function worker() {
  while (cursor < files.length) {
    ...
    if (uploaded % 50 === 0) {
      ...
      console.log(`Đã tải ${uploaded} biến thể WebP lên R2...`);
    }
  }
}
...
console.log(`Hoàn tất R2 variants: ${files.length} files, ${uploaded} files mới.`);
