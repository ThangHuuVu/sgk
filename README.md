...
- `generated/r2-variants/`: ảnh WebP sinh ra cục bộ, không đưa lên Git.
...
Sinh ảnh WebP tối ưu từ thư mục `images/`:
...
R2_PUBLIC_URL="https://pub-a62bc4818d9149eb90b320d773647cd8.r2.dev" \
npm run r2:upload
```
